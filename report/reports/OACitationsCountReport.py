...
class OACitationsCountReport(Report):
    ...
    def run(self, outfile=None):
        val_or_zero = lambda citations: citations if citations is not None else 0
        ...
        gold_citations = val_or_zero(gold_citations)
        ...
        hybrid_citations = val_or_zero(hybrid_citations)
        ...
        bronze_citations = val_or_zero(bronze_citations)
        ...
        green_citations = val_or_zero(green_citations)
        ...
        gold_green_citations = val_or_zero(gold_green_citations)
        ...
        hybrid_green_citations = val_or_zero(hybrid_green_citations)
        ...
        bronze_green_citations = val_or_zero(bronze_green_citations)
        ...
        more_than_one_green_citations = val_or_zero(more_than_one_green_citations)
        ...
        all_green_citations = val_or_zero(all_green_citations)
